...
public class SFDCPatchData {
	...
	public boolean updateAccount(Account acc)
	{
		...
		try
		{
			...
			HttpPatch httpPatch = new HttpPatch(SFDCConnector.INSTANCE.getInstanceURL()+"/services/data/v29.0/sobjects/Account/"+acc.getId());
			httpPatch.addHeader("Authorization", "Bearer "+ SFDCConnector.INSTANCE.getAccessToken());
			...
			{
				System.out.println("Updated Failed:"+response.getStatusLine().getStatusCode());
			}
